...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role='group'
      className={cn(
        'group/input-group border-input has-disabled:bg-input/50 relative flex h-8 w-full min-w-0 items-center rounded-lg border transition-colors outline-none',
        'in-data-[slot=combobox-content]:focus-within:border-inherit in-data-[slot=combobox-content]:focus-within:ring-0 has-disabled:opacity-50',
        'has-[[data-slot=input-group-control]:focus-visible]:ring-3',
        'has-[[data-slot][aria-invalid=true]]:ring-3 has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-start]]:[&>input]:pb-3',
        'has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col',
        'has-[>textarea]:h-auto has-[>[data-align=block-end]]:[&>input]:pt-3',
